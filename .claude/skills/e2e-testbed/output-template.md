...
Fill this template in and write it to `runs/<YYYY-MM-DD>-<topic>.md` in this repo, redacted
as `runs/README.md` says (this repo is public). **Reports are committed; but never paste a report's
